...
memories = store.search(namespace, query=str(question.content))执行此方法会报错，qwen的embedding模型问题：
openai.BadRequestError: Error code: 400 - {'error': {'code': 'InvalidParameter', 'param': None, 'message': 
'<400> InternalError.Algo.InvalidParameter: Value error, contents is neither str nor list of str.: input.contents', 'type': 'InvalidParameter'},
'id': '54835af2-ac3b-435f-a7b5-f91ecc505221', 'request_id': '54835af2-ac3b-435f-a7b5-f91ecc505221'}

经过分析后，langchain_openai/embeddings包中的base.py源码中默认如下代码的true改为false即可
check_embedding_ctx_length: bool = False 
路径如下：G:\develop\conda\envs\langgraph-project\Lib\site-packages\langchain_openai\embeddings

(/storage/conda_envs/vllm) root@iuzhou-System-Product-Name:/storage# vllm serve /storage/models/Qwen2.5-7B-Instruct/--enable-auto-tool-choice --tool-call-parser hermes

(/storage/conda_envs/embedding) root@iuzhou-System-Product-Name:/storage/models# python run_embedding.py